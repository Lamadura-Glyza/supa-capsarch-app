...
export const getAllProjects = async () => {
  ...
  const projectsWithCounts = data.map(project => ({
    ...project,
    like_count: project.project_likes?.length || 0,
    comment_count: project.project_comments?.length || 0,
    bookmark_count: project.project_bookmarks?.length || 0,
  ...
  console.log(`Admin getAllProjects processing took: ${Date.now() - processStart}ms`);
  console.log(`Total admin getAllProjects time: ${Date.now() - startTime}ms`);
